...
class Premise(models.Model):
    ...
    base_rent = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(0)])
...
class PremiseRate(models.Model):
    ...
    rate_type = models.CharField(max_length=50, choices=[('weekday','Weekday'),('weekend','Weekend'),('holiday','Holiday')])
...
class TimeSlot(models.Model):
    premise = models.ForeignKey(Premise, on_delete=models.CASCADE, related_name='time_slots')
