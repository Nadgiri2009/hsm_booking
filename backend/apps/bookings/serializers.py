...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = '__all__'
        read_only_fields = ['booking_id', 'status', 'created_at', 'approved_at', 'approved_by']
...
class BookingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = ['id','booking_id','full_name','mobile','email','premise_name','slot_name','from_date','to_date','total_payable','status','created_at']
