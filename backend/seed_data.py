...
# Create premises
premises_data = [
    {'name': 'Hutatma Smruti Mandir – Main Hall', 'name_mr': 'हुतात्मा स्मृती मंदिर – मुख्य सभागृह', 'capacity': 500, 'base_rent': 15000, 'security_deposit': 25000},
    {'name': 'VIP Room', 'name_mr': 'व्हीआयपी रूम', 'capacity': 50, 'base_rent': 5000, 'security_deposit': 10000},
    {'name': 'Dining Hall', 'name_mr': 'डायनिंग हॉल', 'capacity': 200, 'base_rent': 8000, 'security_deposit': 15000},
    {'name': 'Art Gallery', 'name_mr': 'कला दालन', 'capacity': 100, 'base_rent': 6000, 'security_deposit': 12000},
    {'name': 'Open Space (Lawn)', 'name_mr': 'खुली जागा', 'capacity': 300, 'base_rent': 10000, 'security_deposit': 20000},
]
...
for pd in premises_data:
    ...
    if created:
        ...
        TimeSlot.objects.create(premise=premise, name='Morning Session', start_time='06:00', end_time='12:00', multiplier=0.5)
        TimeSlot.objects.create(premise=premise, name='Full Day', start_time='08:00', end_time='22:00', multiplier=1.0)
        TimeSlot.objects.create(premise=premise, name='Evening Session', start_time='16:00', end_time='23:00', multiplier=0.6)
