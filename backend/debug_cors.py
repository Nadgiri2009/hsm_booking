...
print('CORS_ALLOWED_ORIGIN_REGEXES =', getattr(settings, 'CORS_ALLOWED_ORIGIN_REGEXES', None))
print('CorsMiddleware in MIDDLEWARE:', any('corsheaders.middleware.CorsMiddleware' in m for m in settings.MIDDLEWARE))
