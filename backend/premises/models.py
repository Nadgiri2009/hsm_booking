...
class Premise(models.Model):
    ...
    base_rate = models.DecimalField(max_digits=12, decimal_places=2, help_text='Per day base rate')
    security_deposit = models.DecimalField(max_digits=12, decimal_places=2)
    icon = models.CharField(max_length=50, default='location_on', help_text='Material icon name')
...
class GalleryItem(models.Model):
    ...
    premise = models.ForeignKey(Premise, on_delete=models.CASCADE, related_name='gallery', null=True, blank=True)
