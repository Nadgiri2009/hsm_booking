...
class CancellationRequestView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({'message': 'Booking not found or not eligible for cancellation.'}, status=404)
        ...
        if not otp:
            ...
            return Response({'success': True, 'message': 'OTP sent to registered mobile number.'})
            ...
            try:
                ...
                if timezone.now() > cancellation.otp_expires_at:
                    return Response({'message': 'OTP expired. Please request again.'}, status=400)
                ...
                return Response({'message': 'No pending cancellation found.'}, status=400)
...
class AdminCancellationListView(generics.ListAPIView):
    ...
    search_fields = ['booking__booking_id', 'booking__applicant_name', 'booking__mobile']
...
class AdminCancellationApproveView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            return Response({'success': True, 'message': 'Cancellation approved. Refund will be processed.'})
        except Cancellation.DoesNotExist:
