...
urlpatterns = [
    ...
    path('admin/<int:pk>/approve/', AdminCancellationApproveView.as_view(), name='admin-cancel-approve'),
    path('admin/<int:pk>/reject/', AdminCancellationRejectView.as_view(), name='admin-cancel-reject'),
]
